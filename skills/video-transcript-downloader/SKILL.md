...
Transcript behavior:
- YouTube: fetch via Firecrawl first.
- If Firecrawl does not surface transcript text, fall back to `youtube-transcript-plus`.
...
- Firecrawl is the primary YouTube transcript extractor; the legacy library is fallback only.
